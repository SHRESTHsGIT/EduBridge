...
{
    cout << "********* 🏛️ Welcome to our EduBridge Classroom 🏛️ **********";
    cout << "\n------ Main Menu ------" << endl;
    ...
    while (true) {
        ...
        switch (choice) {
            ...
            case 4:
                ...
                return 0;
             case 5:
             cout<< "\n----- I,Shresth Shankhdhar who made this model of 'EduBridge Classroom' would like to convey special thanks to Mrs. Pooja mam, Faculty of Introduction to Object Oriented Programming, for teaching us all the necessary oops concepts to make this project ---------\n\n";
             break;
            default:
